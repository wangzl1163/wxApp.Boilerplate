...
GlobalEnum.cardType = function () { //证件类型
  return [
    ...
    { id: '10', name: '港澳通行证' },
    { id: '15', name: '士兵证' },
    { id: '16', name: '外国人永久居留身份证' },
    { id: '25', name: '港澳居民来往内地通行证' },
    { id: '26', name: '台湾居民来往内地通行证' },
    { id: '99', name: '其他' }
  ];
}.bind(GlobalEnum)();
