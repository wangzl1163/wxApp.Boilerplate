...
function getBankNameByCardNo(cardNo, cbf) {
  _getBankInfoByCardNo(cardNo, function(err, info) {
    if (!err && info) {
      return cbf(null, info);
    } else {
      return cbf('未识别出对应的银行名称', null);
    }
  });
}
...
module.exports = {
  getBankBin: getBankBin,
  getBankNameByCardNo: getBankNameByCardNo
}